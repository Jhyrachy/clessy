...
var FILTER = []string{
	...
	"ero", "fa", "fai", "fanno", "fare", "fatto", "finché", "gia", "già", "giù", "gli", "hai", "han", "hanno",
	...
	"sei", "sempre", "sennò", "senza", "si", "sia", "siamo", "siano", "siete", "solo", "son", "sono",
	"sopra", "sta", "stai", "ste", "sti", "stiamo", "sto", "sua", "sue", "sui", "sul", "sulla",
	"sulle", "suo", "suoi", "sì", "tanta", "tante", "tanti", "tanto", "te", "that", "the",
	"then", "tipo", "too", "tra", "troppi", "troppo", "tua", "tuo", "tuoi", "tutta", "tutte",
